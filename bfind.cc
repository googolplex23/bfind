...
// -*- compile-command: "g++ -Wall -pedantic -O3 afind.cc -o afind" -*-

/*
  AFind - spaceship searching in Life-like cellular automata
...
//---------------------------------------------------------------------------
// input data:
static char rule_string[32] = "b34/s02578";
...
static int width = 12;
static int period = 5;
static int offset = 2;		// the y offset
static int slide = 1;		// the x offset
...
static int queue_bits = 23, hash_bits = 23;
...
int finder::difference (index_t p)
{
	...
	row_t A[num_rows], B[num_rows], C[num_rows];
